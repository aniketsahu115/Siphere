  ...
  const technicalFeatures = [
    {
      ...
      icon: Zap,
      features: [
        { name: "Scheduled Execution", description: "Precise timing based on user preferences" },
        { name: "Gas Optimization", description: "Minimal transaction costs on Solana" },
        { name: "Failure Recovery", description: "Automatic retry mechanisms" },
        { name: "Multi-Protocol Support", description: "Integration with top DeFi protocols" }
      ]
    },
    {
      category: "Security",
      icon: Lock,
      features: [
        { name: "Audited Smart Contracts", description: "Third-party security audits" },
        { name: "Multi-sig Controls", description: "Distributed key management" },
        { name: "Upgrade Mechanisms", description: "Secure protocol updates" },
        { name: "Insurance Coverage", description: "Optional protection against risks" }
      ]
    },
    {
      category: "Analytics",
      icon: BarChart3,
      features: [
        { name: "Real-time Tracking", description: "Live portfolio performance" },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Everything you need for automated cryptocurrency investing with institutional-grade 
                security, transparency, and yield optimization.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {mainFeatures.map((feature, index) => (
                ...
                >
                  <Card className={`glass-card hover:bg-card/70 transition-all duration-300 h-full border-2 ${
                    activeFeature === index ? 'border-primary/50 bg-primary/5' : 'hover:border-primary/30'
                  }`}>
                    <CardHeader>
                      <motion.div 
                ...
                <Card className="glass-card border-2 border-primary/20">
                  <CardHeader>
                    <div className="flex items-center space-x-4 mb-6">
                      <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${mainFeatures[activeFeature].gradient} flex items-center justify-center`}>
                        {React.createElement(mainFeatures[activeFeature].icon, { 
                          className: `w-8 h-8 ${mainFeatures[activeFeature].color}` 
                        })}
                      </div>
                      <div>
                        <CardTitle className="text-2xl">{mainFeatures[activeFeature].title}</CardTitle>
                        <CardDescription className="text-lg">{mainFeatures[activeFeature].description}</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div>
                      <h4 className="font-semibold mb-4 text-primary">How It Works</h4>
                    ...
                    <div>
                      <h4 className="font-semibold mb-4 text-green-400">Key Benefits</h4>
                      <ul className="space-y-3">
        ...
        <section className="py-24 bg-muted/10">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                { label: "Execution Success Rate", value: "99.8%", icon: Target },
                { label: "Average Transaction Cost", value: "$0.01", icon: DollarSign },
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Start your automated DeFi investment journey today with all these powerful features
              </p>
